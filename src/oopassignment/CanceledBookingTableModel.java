...
public class CanceledBookingTableModel extends AbstractTableModel implements SelectableTableModel {
    ...
    public CanceledBookingTableModel(ArrayList<booking> bookings) {
        data = new ArrayList<>();
        for (booking B : bookings) {
            if(B.getBookingStatus().equals("Canceled")){
