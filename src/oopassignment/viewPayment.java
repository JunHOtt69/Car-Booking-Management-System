...
public class viewPayment extends javax.swing.JFrame {
    oopassignment.PaymentTableModel paymentModel = new oopassignment.PaymentTableModel(DataIO.payments);
    
    ArrayList<Object[]> originalPaymentData = paymentModel.getBookingData();
    ...
    private void initComponents() {
        ...
        TableStyler.stylePaymentTable(paymentTable, jScrollPane1);
        ...
        jLabel3.setText("View all Payment ");
    ...
    private void returnPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnPageActionPerformed
        ...
        Main.viewPayment.setVisible(false);
    ...
    private void searchBarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchBarKeyReleased
        ...
        for (Object[] row : originalPaymentData) {
            if (rowContains(row, 0, 12, keyword)) {
    ...
    public void refreshPage(ArrayList<payment> payments){
        paymentModel= new PaymentTableModel(payments);
        paymentTable.setModel(paymentModel);
        TableStyler.stylePaymentTable(paymentTable, jScrollPane1);
    }
