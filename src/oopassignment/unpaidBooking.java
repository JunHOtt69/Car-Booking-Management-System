...
public class unpaidBooking extends javax.swing.JFrame {
    oopassignment.UnpaidBookingTableModel bookingModel = new oopassignment.UnpaidBookingTableModel(DataIO.bookings);
    
    ArrayList<Object[]> originalBookingData = bookingModel.getBookingData();

    public unpaidBooking() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TableStyler.styleCanceledBookingTable(bookingTable, jScrollPane1);
        ...
        jLabel3.setText("Unpaid Bookings");
    ...
    private void returnPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnPageActionPerformed
        ...
        Main.unpaidBooking.setVisible(false);
    ...
    public void refreshPage(ArrayList<booking> bookings){
        bookingModel= new UnpaidBookingTableModel(bookings);
        bookingTable.setModel(bookingModel);
        TableStyler.styleCanceledBookingTable(bookingTable, jScrollPane1);
    }
