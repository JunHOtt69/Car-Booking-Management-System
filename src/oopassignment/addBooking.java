...
public class addBooking extends javax.swing.JDialog{
    private manageCarSalesman parent;
    ...
    public addBooking(java.awt.Frame parent, boolean modal, String salesmanID) {
        super(parent, modal);
        this.parent = (manageCarSalesman)parent;
    ...
    private void initComponents() {
        ...
        next1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        next1.setText("Next");
        ...
        jLabel4.setText("Create New Booking");
        ...
        customer.setPreferredSize(new java.awt.Dimension(835, 180));
        customer.setLayout(new java.awt.BorderLayout());

        jPanel17.setPreferredSize(new java.awt.Dimension(400, 180));
        ...
        next2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        next2.setText("Next");
        ...
        jPanel27.setPreferredSize(new java.awt.Dimension(400, 180));
        ...
        jPanel35.setPreferredSize(new java.awt.Dimension(50, 180));
        ...
        jPanel19.setPreferredSize(new java.awt.Dimension(340, 34));
        ...
        jPanel19.add(bankAccount, java.awt.BorderLayout.EAST);
        ...
        jPanel19.add(jLabel22, java.awt.BorderLayout.WEST);
        ...
        jPanel20.add(deposit, java.awt.BorderLayout.EAST);
        ...
        jPanel20.add(jLabel25, java.awt.BorderLayout.WEST);
        ...
        jPanel21.add(jLabel21, java.awt.BorderLayout.WEST);
        ...
        jPanel21.add(totalPayableAmount, java.awt.BorderLayout.EAST);
        ...
        back2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        back2.setText("Back");
        ...
        paymentSectionLayout.setVerticalGroup(
            ...
            .addGroup(paymentSectionLayout.createSequentialGroup()
                ...
                .addGroup(paymentSectionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(paymentSectionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(book)
                        .addComponent(back2)))
                .addGap(77, 77, 77)
    ...
    private void next1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_next1ActionPerformed
        String keyword = carID.getText().trim().toLowerCase(); // or separate fields like carIDField

        car matchedCar = null;

        for (car c : DataIO.cars) {
            if (c.getCarID().toLowerCase().contains(keyword))
            {
                matchedCar = c;
                break;
            }
        ...
        if (matchedCar == null) {
            JOptionPane.showMessageDialog(this,
                "No car found matching your input.",
                "Search Result",
                JOptionPane.WARNING_MESSAGE);
            return;
        }
        else if (matchedCar.getCarStatus().equals("Available")){
            this.selectedCar = matchedCar;
            setVisibleStep2(matchedCar);
        }

        else {
            JOptionPane.showMessageDialog(this,
                "This car is currently not available for booking. \nStatus:" + matchedCar.getCarStatus(),
                "Car not available",
                JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void bookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookActionPerformed
        ...
        for (booking Booking : DataIO.bookings){
            if (Booking.getCarID().equals(selectedCar.getCarID()) &&
                Booking.getBookingStatus().equals("Requesting Booking")){
        ...
        parent.refreshPage(DataIO.cars);
    }//GEN-LAST:event_bookActionPerformed

    private void next2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_next2ActionPerformed
        String email = this.email.getText().trim(); 

        Customer matchedCustomer = DataIO.searchCustomer(email);
        if (matchedCustomer == null) {
            JOptionPane.showMessageDialog(this,
                "No customer found matching your input.",
                "Search Result",
                JOptionPane.WARNING_MESSAGE);
            return;
        }
            ...
            for(booking b : DataIO.bookings){
                if(b.getCustomerID().equals(matchedCustomer.getCustomerID()) &&
                        b.getCarID().equals(selectedCar.getCarID())){
                    JOptionPane.showMessageDialog(this,
                        "Customer has already request booking for this car. Please confirm the booking.",
                        "Search Result",
                        JOptionPane.WARNING_MESSAGE);
                    return;
                }
            ...
            setVisibleStep3(matchedCustomer);
        }
    }//GEN-LAST:event_next2ActionPerformed

    private void back2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_back2ActionPerformed
        setVisibleStep2(this.selectedCar);
    ...
    private void setVisibleStep2(car selectedCar){
    ...
    private void setVisibleStep3(Customer selectedCustomer){
        ...
        try {
            ...
            double totalPayableAmount = originalPrice - deposit;
            ...
            this.totalPayableAmount.setText("RM 0.00");
            System.err.println("Invalid price format: " + priceStr);
        }
    }
