...
public class canceledBooking extends javax.swing.JFrame {
    oopassignment.CanceledBookingTableModel bookingModel = new oopassignment.CanceledBookingTableModel(DataIO.bookings);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Canceled Bookings");
    ...
    private void returnPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnPageActionPerformed
        ...
        Main.canceledBooking.setVisible(false);
    ...
    public void refreshPage(ArrayList<booking> bookings){
        bookingModel= new CanceledBookingTableModel(bookings);
        bookingTable.setModel(bookingModel);
        TableStyler.styleCanceledBookingTable(bookingTable, jScrollPane1);
    }
